...
class CreatePorts {
    ...
    createCreate(){
        ...
        const text = `
        export interface ICreate${this.className} {
    ...
    createUpdate(){
        ...
        const text = `
        export interface IUpdate${this.className} {
            execute(data: any):Promise<any>
        }`;
        this.elSalvador.saveFile(text)
    }
    createDelete(){
        ...
        const text = `
        export interface IDelete${this.className} {
            execute(data: any):Promise<any>
        }`;
        this.elSalvador.saveFile(text)
    }
    createGetAll(){
        ...
        const text = `
        export interface IGetAll${this.className}s {
            execute(data: any):Promise<any>
        }`;
        this.elSalvador.saveFile(text)
    }
    createGetById(){
        ...
        const text = `
        export interface IGet${this.className} {
            execute(data: any):Promise<any>
        }`;
        this.elSalvador.saveFile(text)
    }
